...
proc create_hier_cell_decimation_pipeline { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net S_AXIS_DATA_Q_1 [get_bd_intf_pins S_AXIS_DATA_Q] [get_bd_intf_pins stage1_Q/S_AXIS_DATA]
  ...
  connect_bd_net -net areset_1 [get_bd_pins areset] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins aclk] [get_bd_pins stage1_I/aclk] [get_bd_pins stage2_I/aclk] [get_bd_pins stage1_Q/aclk] [get_bd_pins stage2_Q/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins stage3_I/aclk] [get_bd_pins stage3_Q/aclk] [get_bd_pins stage4_I/aclk] [get_bd_pins stage4_Q/aclk] [get_bd_pins stage5_Q/aclk] [get_bd_pins stage5_I/aclk] [get_bd_pins stage6_I/aclk] [get_bd_pins stage6_Q/aclk] [get_bd_pins stage7_I/aclk] [get_bd_pins stage7_Q/aclk]

  # Perform GUI Layout
  regenerate_bd_layout -hierarchy [get_bd_cells /decimation_pipeline] -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.625003",
   "Default View_TopLeft":"1030,-189",
...
preplace port S_AXIS_DATA_Q -pg 1 -lvl 0 -x -20 -y 160 -defaultsOSRD
preplace port M_AXIS -pg 1 -lvl 11 -x 3310 -y 250 -defaultsOSRD
...
preplace inst axis_combiner_0 -pg 1 -lvl 8 -x 2180 -y 200 -defaultsOSRD
preplace inst axis_subset_converter_0 -pg 1 -lvl 9 -x 2520 -y 220 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 10 -x 2820 -y 240 -defaultsOSRD
...
preplace inst stage7_I -pg 1 -lvl 7 -x 1860 -y 80 -defaultsOSRD
preplace inst stage7_Q -pg 1 -lvl 7 -x 1860 -y 340 -defaultsOSRD
preplace netloc areset_1 1 0 10 40J 210 NJ 210 N 210 N 210 N 210 N 210 N 210 2010 290 2370 300 2670
preplace netloc rfdc_clk_adc0 1 0 10 30 90 330 100 610 110 890 120 1170 130 1450 140 1730 220 2030 300 2360 310 2680
preplace netloc S_AXIS_DATA_Q_1 1 0 1 0 160n
preplace netloc axis_combiner_0_M_AXIS 1 8 1 N 200
preplace netloc axis_data_fifo_0_M_AXIS 1 10 1 2940 240n
preplace netloc axis_subset_converter_0_M_AXIS 1 9 1 N 220
...
preplace netloc stage6_I_M_AXIS_DATA 1 6 1 N 70
preplace netloc stage6_Q_M_AXIS_DATA 1 6 1 N 330
preplace netloc stage7_I_M_AXIS_DATA 1 7 1 1990 80n
preplace netloc stage7_Q_M_AXIS_DATA 1 7 1 2020 190n
levelinfo -pg 1 -20 170 460 740 1020 1300 1580 1860 2180 2520 2820 3310
pagesize -pg 1 -db -bbox -sgen -180 -170 3410 580
"
}
...
\
  ...
  set_property -dict [list \
    CONFIG.ADC0_Outclk_Freq {160.000} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT1_JITTER {87.052} \
    CONFIG.CLKOUT1_PHASE_ERROR {84.008} \
  ...
  connect_bd_intf_net -intf_net rfdc_m00_axis [get_bd_intf_pins rfdc/m00_axis] [get_bd_intf_pins decimation_pipeline/S_AXIS_DATA_I]
  connect_bd_intf_net -intf_net rfdc_m01_axis [get_bd_intf_pins decimation_pipeline/S_AXIS_DATA_Q] [get_bd_intf_pins rfdc/m01_axis]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins axi_smc/aclk1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins rfdc/m0_axis_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins decimation_pipeline/aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_smc/aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rfdc/m0_axis_aresetn] [get_bd_pins decimation_pipeline/areset]
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins rfdc/clk_adc0] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins rst_ps8_0_96M/peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins rfdc/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins axi_smc/aresetn]
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs rfdc/s_axi/Reg] -force
  ...
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.840057",
   "Default View_TopLeft":"188,-265",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port sysref_in -pg 1 -lvl 0 -x -10 -y -30 -defaultsOSRD
preplace port adc0_clk -pg 1 -lvl 0 -x -10 -y -90 -defaultsOSRD
preplace port vin0_01 -pg 1 -lvl 0 -x -10 -y -60 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 5 -x 1590 -y -160 -defaultsOSRD
preplace inst rfdc -pg 1 -lvl 1 -x 250 -y -30 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -x 250 -y 190 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 250 -y 340 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 4 -x 1065 -y -190 -defaultsOSRD
preplace inst decimation_pipeline -pg 1 -lvl 2 -x 700 -y -40 -defaultsOSRD
preplace inst rst_ps8_0_96M -pg 1 -lvl 6 -x 2115 -y 90 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 7 -x 2500 -y -330 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 7 -x 2500 -y -90 -defaultsOSRD
preplace netloc Net 1 0 7 40 -180 NJ -180 NJ -180 895J -90 1280 -250 1930 -250 2330
preplace netloc clk_wiz_0_clk_out1 1 0 7 50 -170 440 -170 N -170 885 -80 1270 -270 N -270 2300
preplace netloc clk_wiz_0_locked 1 0 2 70 120 430
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 0 2 70 100 450
preplace netloc rfdc_clk_adc0 1 0 2 60 110 430
preplace netloc rst_ps8_0_96M_peripheral_aresetn 1 0 7 70 -160 NJ -160 NJ -160 875 -70 1260J -300 1900J -290 2340
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 6 30 -290 NJ -290 NJ -290 NJ -290 NJ -290 1890
preplace netloc adc0_clk_1 1 0 1 10J -90n
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 3 1240J -280 NJ -280 2320
preplace netloc axi_smc_M00_AXI 1 4 4 1290 -470 NJ -470 NJ -470 2670
preplace netloc axis_combiner_0_M_AXIS 1 2 2 830 -210 N
preplace netloc ps8_0_axi_periph_M00_AXI 1 3 5 895 -310 NJ -310 1910J -300 2350J -180 2660
preplace netloc ps8_0_axi_periph_M01_AXI 1 0 8 20 -300 NJ -300 NJ -300 NJ -300 1250J -260 NJ -260 2310J -190 2650
preplace netloc rfdc_m00_axis 1 1 1 430 -70n
preplace netloc rfdc_m01_axis 1 1 1 450 -50n
preplace netloc sysref_in_1 1 0 1 10J -40n
preplace netloc vin0_01_1 1 0 1 NJ -60
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 5 2 1920J -310 2300
levelinfo -pg 1 -10 250 700 850 1065 1590 2115 2500 2690
pagesize -pg 1 -db -bbox -sgen -450 -560 5490 440
"
}
