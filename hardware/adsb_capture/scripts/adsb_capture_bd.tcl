...
################################################################
# This is a generated script based on design: adsb_capture
#
...
# source adsb_capture_script.tcl
...
\
  ...
  # Create instance: control_smc, and set properties
  set control_smc [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 control_smc ]
  set_property -dict [list \
    CONFIG.NUM_MI {5} \
    CONFIG.NUM_SI {1} \
  ] $control_smc
  ...
  set_property CONFIG.RESET_BOARD_INTERFACE {Custom} $rst_100m


  # Create instance: clock_locked, and set properties
  set clock_locked [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 clock_locked ]
  ...
  # Create instance: subset_q, and set properties
  set subset_q [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_subset_converter:1.1 subset_q ]
  set_property -dict [list \
    CONFIG.M_HAS_TKEEP {0} \
    CONFIG.M_HAS_TLAST {0} \
    CONFIG.M_HAS_TSTRB {0} \
  ...
  # Create instance: capture_gate, and set properties
  set block_name axis_capture_gate
  set block_cell_name capture_gate
  if { [catch {set capture_gate [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $capture_gate eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: capture_fifo, and set properties
  set capture_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 capture_fifo ]
  set_property -dict [list \
  ...
  # Create instance: stream_cdc, and set properties
  set stream_cdc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_clock_converter:1.1 stream_cdc ]
  set_property -dict [list \
    CONFIG.HAS_TLAST {1} \
    CONFIG.TDATA_NUM_BYTES {4} \
  ] $stream_cdc
  ...
  # Create instance: capture_control, and set properties
  set capture_control [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 capture_control ]
  set_property -dict [list \
  ...
  # Create instance: capture_status, and set properties
  ...
  # Create instance: memory_smc, and set properties
  set memory_smc [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect:1.0 memory_smc ]
  set_property CONFIG.NUM_SI {1} $memory_smc
  ...
  connect_bd_intf_net -intf_net rfdc_m10_axis [get_bd_intf_pins rfdc/m10_axis] [get_bd_intf_pins decimator/s_axis_re]
  connect_bd_intf_net -intf_net rfdc_m11_axis [get_bd_intf_pins rfdc/m11_axis] [get_bd_intf_pins decimator/s_axis_im]
  ...
  connect_bd_intf_net -intf_net vin1_01_0_1 [get_bd_intf_ports vin1_01_0] [get_bd_intf_pins rfdc/vin1_01]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD] [get_bd_intf_pins control_smc/S00_AXI]
